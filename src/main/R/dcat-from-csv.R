...
df <- read.csv(file = "../resources/be/vlaanderen/omgeving/data/id/dataset/codelijst-bioindicator/catalog.csv", sep=",", na.strings=c("","NA"))
...
write.csv(df,"../resources/be/vlaanderen/omgeving/data/id/dataset/codelijst-bioindicator/catalog.csv", row.names = FALSE)
df <- df %>%
...
context <- jsonlite::read_json("../resources/be/vlaanderen/omgeving/data/id/dataset/codelijst-bioindicator/context.json")
df_in_list <- list('@graph' = df, '@context' = context)
df_in_json <- toJSON(df_in_list, auto_unbox=TRUE)
write(df_in_json, "/tmp/catalog.jsonld")
system("riot --formatted=TURTLE /tmp/catalog.jsonld > ../resources/be/vlaanderen/omgeving/data/id/dataset/codelijst-bioindicator/catalog.ttl")
system("riot --formatted=JSONLD ../resources/be/vlaanderen/omgeving/data/id/dataset/codelijst-bioindicator/catalog.ttl > ../resources/be/vlaanderen/omgeving/data/id/dataset/codelijst-bioindicator/catalog.jsonld")
